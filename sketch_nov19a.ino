...
void loop() {
  ...
  while ((( valSensorDir > 100 || valSensorFre > 100)) and valSensorEsq < 100 and valSensorDir2 < 100 and valSensorEsq2 < 100){
direita ();
delay(1500);
  }
  
  while ((( valSensorEsq > 100 || valSensorFre > 100)) and valSensorDir < 100 and valSensorDir2 < 100 and valSensorEsq2 < 100){
 esquerda();
 delay(1500);
  }
